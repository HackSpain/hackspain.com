...
export const TRACK_SPONSORS_DETAIL: TrackSponsor[] = [
  ...
  },
  {
    ...
    description:
      "Robots industriales reconfigurables, entrenados con IA para no especializarse en una sola tarea. Desde Barcelona, con la mayor Serie A de robótica de Europa: 85M$ liderados por CRV, con Samsung, LVMH e Inditex dentro.",
    id: "theker",
    logoHeight: "h-[clamp(1.5rem,3.6vw,2.1rem)]",
